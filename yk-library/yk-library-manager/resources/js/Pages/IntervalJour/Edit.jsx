...
export default function Edit({ auth , interval}) {

    const { data, setData, put, processing, errors,reset } = useForm({
        id_interval_jour: interval.id_interval_jour,
        libelle_interval_jour:interval.libelle_interval_jour,
        valeur_interval_jour:interval.valeur_interval_jour,
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        put(route("intervals.update", interval.id_interval_jour));
    };

    return (
        <AuthenticatedLayout auth={auth}>
              <Title titre={'Ajouter Interval'} />
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="sm:col-span-1">
                                        ...
                                        <div className="relative">
                                            ...
                                            <TextInput
                                            type="number"
                                            value={data.valeur_interval_jour}
                                            onChange={(e) => setData("valeur_interval_jour", e.target.value)}
                                            placeholder="0"
                                        ...
                                        {errors.valeur_interval_jour && <div className="text-red-500">{errors.valeur_interval_jour}</div>}
                                        </div>
                                        ...
                                        <div className="w-full">
                                            ...
                                            <div className="relative">
                                                ...
                                                <TextInput 
                                                type="text"
                                                value={data.libelle_interval_jour}
                                                onChange={(e) => setData("libelle_interval_jour", e.target.value)}
                                                placeholder="Libelle"
                                            ...
                                            {errors.libelle_interval_jour && <div className="text-red-500">{errors.libelle_interval_jour}</div>}
                                            </div>
