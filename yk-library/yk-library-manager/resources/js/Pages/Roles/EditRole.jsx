...
export default function EditRole({ auth, role }) {
    ...
    const { data, setData, post, processing, errors, reset } = useForm({
        codeRole: role.code_role,
        libelleRole: role.libelle_role,
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        //console.log(data);
        post(route("roles.update", role.id_role));
    };
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        placeholder="Saisir le code du role"
                                    />
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        type="text"
                                        className="peer py-3 px-4 ps-11 block w-full bg-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none border-transparent focus:outline-none dark:bg-[#262a2f] dark:caret-[#ced4da] dark:text-[#ced4da] mt-1 px-12"
                                        placeholder="Saisir le libellé du role"
                                    />
                                    <div className="absolute inset-y-0 flex items-center pointer-events-none start-0 ps-4 peer-disabled:opacity-50 peer-disabled:pointer-events-none">
                                        <svg
                                            className="flex-shrink-0 w-5 h-5 font-extrabold text-gray-500"
                                                ...
                                                <div className="flex gap-4">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="relative">
                                                            <input
                                                                ...
                                                                type="text"
                                                                className="peer py-3 px-4 ps-11 block w-full bg-gray-100 rounded-lg text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none border-transparent focus:outline-none dark:bg-[#262a2f] dark:caret-[#ced4da] dark:text-[#ced4da] mt-1 px-12"
                                                                placeholder="Saisir le code du role"
                                                            />
                                                            <div className="absolute inset-y-0 flex items-center pointer-events-none start-0 ps-4 peer-disabled:opacity-50 peer-disabled:pointer-events-none">
                                                                <svg
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="relative">
                                                            <input
                                                                id="libelleRole"
                                                                value={data.libelleRole}
                                                                name="libelleRole"
                                                                autoComplete="libelleRole"
                                                                onChange={(e) =>
                                                                    setData(
                                                                        "libelleRole",
                                                                        e.target
                                                ...
                                                <div className="flex gap-4 mt-4">
                                                    ...
                                                    <div className="flex-1 mt-4">
                                                        <button
                                                            ...
                                                            className="px-4 py-2 font-bold text-white bg-blue-500 rounded hover:bg-blue-700 me-4"
                                                        >
